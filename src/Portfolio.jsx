        ...
        <div style={{ display: "flex", gap: "24px", alignItems: "flex-start" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", gap: "20px", marginBottom: "16px" }}>
              ...
              <div>
                <p style={{ fontFamily: "'Fraunces', serif", fontSize: "32px", fontWeight: 600, color: t.text, margin: 0 }}>10+</p>
                <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "12px", color: t.textDim, margin: 0, letterSpacing: "0.5px" }}>Brands</p>
              </div>
              <div style={{ width: "1px", background: t.border }} />
              <div>
                <p style={{ fontFamily: "'Fraunces', serif", fontSize: "32px", fontWeight: 600, color: t.text, margin: 0 }}>50M+</p>
